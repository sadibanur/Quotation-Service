...
$theDBA->addQuote("Walking on water and developing software from a specification are easy if both are frozen.", "Edward Berard");
$theDBA->addQuote("The most disastrous thing you can do is learn your first programming language.", "Alan Kay");
